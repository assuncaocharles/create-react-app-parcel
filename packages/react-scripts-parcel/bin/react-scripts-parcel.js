...
switch (script) {
  ...
  default:
    ...
    console.log('Perhaps you need to update react-scripts-parcel?');
    console.log(
      'See: [CRAP version of] https://github.com/facebook/create-react-app/blob/master/packages/react-scripts/template/README.md#updating-to-new-releases'
    );
    break;
}
